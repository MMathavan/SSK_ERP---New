...
namespace SSK_ERP.Controllers
{
    ...
    public class CreditNoteReportController : Controller
    {
        ...
        private const string CnConsolidatedView = "VW_CREDITNOTE_CONSOLIDATE_RPT";
        private const string CnDetailedView = "VW_CREDITNOTE_DETAILED_RPT";
        ...
        {
            return ExportFromView(CnConsolidatedView, "CREDIT NOTE DATEWISE - CONSOLIDATED", "SSK_ENTERPRISE_CREDIT_NOTE_DATEWISE_CONSOLIDATED", fromDate, toDate, null);
        }
        ...
        {
            return ExportFromView(CnDetailedView, "CREDIT NOTE DATEWISE - DETAILED", "SSK_ENTERPRISE_CREDIT_NOTE_DATEWISE_DETAILED", fromDate, toDate, null);
        }
        ...
        {
            return ExportFromView(CnConsolidatedView, "CREDIT NOTE CUSTOMER WISE - CONSOLIDATED", "SSK_ENTERPRISE_CREDIT_NOTE_CUSTOMER_WISE_CONSOLIDATED", fromDate, toDate, customerIds);
        }
        ...
        {
            return ExportFromView(CnDetailedView, "CREDIT NOTE CUSTOMER WISE - DETAILED", "SSK_ENTERPRISE_CREDIT_NOTE_CUSTOMER_WISE_DETAILED", fromDate, toDate, customerIds);
        }
