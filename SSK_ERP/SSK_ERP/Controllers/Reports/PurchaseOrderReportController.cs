...
namespace SSK_ERP.Controllers
{
    ...
    public class PurchaseOrderReportController : Controller
    {
        ...
        private const string PoDatewiseConsolidatedView = "VW_PO_DATEWISE_CONSOLIDATE_RPT";
        private const string PoDatewiseDetailedView = "VW_PO_DETAILED_DATEWISE_RPT";
        private const string PoDatewisePendingConsolidatedView = "vw_PO_Consolidate_Pending_POINV_rpt";
        ...
        private static string ResolveDateColumn(DataTable table)
        {
            ...
            foreach (DataColumn col in table.Columns)
            {
                ...
                if (normalized == "purchaseorderdate" ||
                    normalized == "poorderdate" ||
                    normalized == "podate" ||
        ...
        {
            return ExportFromView(PoDatewiseConsolidatedView, "PURCHASE ORDER DATEWISE - CONSOLIDATED", "SSK_ENTERPRISE_PURCHASE_ORDER_DATEWISE_CONSOLIDATED", fromDate, toDate, null);
        }
        ...
        {
            return ExportFromView(PoDatewiseDetailedView, "PURCHASE ORDER DATEWISE - DETAILED", "SSK_ENTERPRISE_PURCHASE_ORDER_DATEWISE_DETAILED", fromDate, toDate, null);
        }
        ...
        {
            return ExportFromView(PoDatewisePendingConsolidatedView, "PURCHASE ORDER DATEWISE - PENDING", "SSK_ENTERPRISE_PURCHASE_ORDER_DATEWISE_PENDING", fromDate, toDate, null);
        }
        ...
        {
            return ExportFromView(PoDatewiseConsolidatedView, "PURCHASE ORDER SUPPLIER WISE - CONSOLIDATED", "SSK_ENTERPRISE_PURCHASE_ORDER_SUPPLIER_WISE_CONSOLIDATED", fromDate, toDate, supplierIds);
        }
        ...
        {
            return ExportFromView(PoDatewiseDetailedView, "PURCHASE ORDER SUPPLIER WISE - DETAILED", "SSK_ENTERPRISE_PURCHASE_ORDER_SUPPLIER_WISE_DETAILED", fromDate, toDate, supplierIds);
        }
