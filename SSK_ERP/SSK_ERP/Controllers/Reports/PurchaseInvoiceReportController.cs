...
namespace SSK_ERP.Controllers
{
    ...
    public class PurchaseInvoiceReportController : Controller
    {
        ...
        private const string PiDatewiseConsolidatedView = "VW_POINVOICE_DATEWISE_RPT";
        private const string PiDatewiseDetailedView = "VW_POINVOICE_DATEWISE_DEATILED_RPT";
        private const string PiDatewisePendingConsolidatedView = "VW_POINVOICE_PENDING_RPT";
        private const string PiDatewisePendingDetailedView = "VW_POINVOICE_DETAILED_PENDING_RPT";
        ...
        private static string ResolveDateColumn(DataTable table)
        {
            ...
            foreach (DataColumn col in table.Columns)
            {
                ...
                if (normalized == "purchaseinvoicedate" ||
        ...
        {
            return ExportFromView(PiDatewiseConsolidatedView, "PURCHASE INVOICE DATEWISE - CONSOLIDATED", "SSK_ENTERPRISE_PURCHASE_INVOICE_DATEWISE_CONSOLIDATED", fromDate, toDate, null);
        }
        ...
        {
            return ExportFromView(PiDatewiseDetailedView, "PURCHASE INVOICE DATEWISE - DETAILED", "SSK_ENTERPRISE_PURCHASE_INVOICE_DATEWISE_DETAILED", fromDate, toDate, null);
        }
        ...
        {
            return ExportFromView(PiDatewisePendingConsolidatedView, "PURCHASE INVOICE DATEWISE - PENDING - CONSOLIDATED", "SSK_ENTERPRISE_PURCHASE_INVOICE_DATEWISE_PENDING_CONSOLIDATED", fromDate, toDate, null);
        }

        [HttpGet]
        [Authorize(Roles = "PurchaseInvoiceReport")]
        public FileResult ExportDatewisePendingDetailed(string fromDate = null, string toDate = null)
        {
            return ExportFromView(PiDatewisePendingDetailedView, "PURCHASE INVOICE DATEWISE - PENDING - DETAILED", "SSK_ENTERPRISE_PURCHASE_INVOICE_DATEWISE_PENDING_DETAILED", fromDate, toDate, null);
        }
        ...
        {
            return ExportFromView(PiDatewiseConsolidatedView, "PURCHASE INVOICE SUPPLIER WISE - CONSOLIDATED", "SSK_ENTERPRISE_PURCHASE_INVOICE_SUPPLIER_WISE_CONSOLIDATED", fromDate, toDate, supplierIds);
        }
        ...
        {
            return ExportFromView(PiDatewiseDetailedView, "PURCHASE INVOICE SUPPLIER WISE - DETAILED", "SSK_ENTERPRISE_PURCHASE_INVOICE_SUPPLIER_WISE_DETAILED", fromDate, toDate, supplierIds);
        }
